...
fn default_bridge() -> String {
    DEFAULT_NETWORK_DRIVER.to_string()
}

fn default_ipam_driver() -> String {
    DEFAULT_IPAM_DRIVER.to_string()
}
...
pub struct NetworkIpam {
    #[serde(default = "default_ipam_driver")]
    pub driver: String,
    #[serde(default)]
